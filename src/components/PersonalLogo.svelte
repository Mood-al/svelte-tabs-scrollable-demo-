<div class="mx-2">
	<a target="_blank" rel="noopener noreferrer" href="https://9mooder7.netlify.app/">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 550.18 217.97">
			...
			<g id="Layer_2" data-name="Layer 2">
				<g id="Layer_1-2" data-name="Layer 1">
					...
					/>
					<path class="cls-2" d="M380.84,203.55s.22-42,.46-86.83" />
					<path class="cls-2 cls-3" d="M381.54,73.44l.37-70.7,165.5,106.52L380.83,216.71" />
				</g>
			</g>
		</svg>
	</a>
